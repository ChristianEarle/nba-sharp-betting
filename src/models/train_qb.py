"""QB bindings of ``src.models.train`` (Phase 4). See ``src.models.train_wr``
...
FEATURES_QB_PATH = SPEC.features_path
...
def load_modeling_frame(
    features_path: Path = FEATURES_QB_PATH,
